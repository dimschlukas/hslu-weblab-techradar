...
@Component({
  selector: 'app-edit-technology-form',
  imports: [
    RouterModule,
    ReactiveFormsModule,
    MatFormFieldModule,
  ...
  templateUrl: './edit-technology-form.component.html',
  styleUrl: './edit-technology-form.component.scss'
})
export class EditTechnologyFormComponent implements OnInit {
